...
print(
    ...
    ' ' * 3,
    out,
    ' 四柱：' + ' '.join([''.join(item) for item in zip(gans, zhis)]),
)
print('-' * 120)
print(
...
print(
    '\033[1;36;40m{1:{0}<15s}{2:{0}<15s}{3:{0}<15s}{4:{0}<15s}\033[0m'.format(
        ...
        '{}{}{}【{}】{}'.format(
            gans.time, yinyang(gans.time), gan5[gans.time], ten_deities[me][gans.time], check_gan(gans.time, gans)
        ),
    )
)
...
print(
    '\033[1;36;40m{1:{0}<15s}{2:{0}<15s}{3:{0}<15s}{4:{0}<15s}\033[0m'.format(
        ...
        '{}{}{}{}【{}】{}{}'.format(
            ...
            ten_deities[gans.month][zhis.year],
            ten_deities[me][zhis.year],
            ten_deities[gans.time][zhis.year],
            get_empty(zhus[2], zhis.year),
        ),
        '{}{}{}{}【{}】{}{}'.format(
            zhis.month,
            yinyang(zhis.month),
            ten_deities[gans.year][zhis.month],
            ten_deities[gans.month][zhis.month],
            ten_deities[me][zhis.month],
            ten_deities[gans.time][zhis.month],
            get_empty(zhus[2], zhis.month),
        ),
        '{}{}{}{}【{}】{}'.format(
            zhis.day,
            yinyang(zhis.day),
            ten_deities[gans.year][zhis.day],
            ten_deities[gans.month][zhis.day],
            ten_deities[me][zhis.day],
            ten_deities[gans.time][zhis.day],
        ),
        '{}{}{}{}【{}】{}{}'.format(
            zhis.time,
            yinyang(zhis.time),
            ten_deities[gans.year][zhis.time],
            ten_deities[gans.month][zhis.time],
